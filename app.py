...
def predict():
    ...
    data = [[int(inputQuery1), float(inputQuery2), float(inputQuery3), inputQuery4, inputQuery5, inputQuery6, inputQuery7, 
             inputQuery8, inputQuery9, inputQuery10, inputQuery11, inputQuery12, inputQuery13, inputQuery14,
             inputQuery15, inputQuery16, inputQuery17, inputQuery18, int(inputQuery19)]]
    ...
    #final_df=pd.concat([new_df__dummies, df_2[['MonthlyCharges', 'SeniorCitizen', 'TotalCharges']]], axis=1)    
